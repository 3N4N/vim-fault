...
" Editor settings
" --------------------------------
hi ColorColumn     gui=none      guibg=#4e4e4e guifg=none    cterm=none      ctermbg=239    ctermfg=none
...
hi Folded          gui=none      guibg=#4e4e4e guifg=none    cterm=none      ctermbg=none   ctermfg=gray
...
hi StatusLine      gui=none      guibg=#abb2bf guifg=#282c34 cterm=none      ctermbg=249    ctermfg=232
...
" Completion menu
" --------------------------------
hi Pmenu           gui=none      guibg=#abb2bf guifg=#282c34 cterm=none      ctermbg=white  ctermfg=235
hi PmenuSbar       gui=none      guibg=#abb2bf guifg=#282c34 cterm=none      ctermbg=white  ctermfg=none
hi PmenuSel        gui=none      guibg=#282c34 guifg=#abb2bf cterm=none      ctermbg=238    ctermfg=white
hi PmenuThumb      gui=none      guibg=#282c34 guifg=none    cterm=none      ctermbg=238    ctermfg=none

" --------------------------------
" Spelling
" --------------------------------
hi SpellBad        gui=none      guibg=#e06c75 guifg=none    cterm=none      ctermbg=red    ctermfg=black
hi SpellCap        gui=none      guibg=#e5c07b guifg=none    cterm=none      ctermbg=yellow ctermfg=black
hi SpellLocal      gui=none      guibg=#61afef guifg=none    cterm=none      ctermbg=blue   ctermfg=black
hi SpellRare       gui=none      guibg=#e06c75 guifg=none    cterm=none      ctermbg=red    ctermfg=black
